...
@Component({
    ...
    template: `
        ...
        @if (preview) {
          <button [attr.aria-label]="zoomImageAriaLabel" type="button" [class]="cx('previewMask')" (click)="onImageClick()" #previewButton [ngStyle]="{ height: height + 'px', width: width + 'px' }" [hBind]="ptm('previewMask')">
