            ...
            @if (headlessTemplate || _headlessTemplate) {
                ...
                <ng-template #content>
                    @if (iconTemplate || _iconTemplate) {
                        ...
                        <i [ngClass]="cx('icon')" [class]="option('icon')" [hBind]="ptm('icon')" *ngIf="option('icon')"></i>
                    }
                    @if (messageTemplate || _messageTemplate) {
                        ...
                        <span [class]="cx('message')" [hBind]="ptm('message')" [innerHTML]="option('message')"> </span>
                    }
                </ng-template>
            }
            <ng-template #footer>
                    ...
                    >
                        <ng-template #icon>
                            @if (rejectIcon && !rejectIconTemplate && !_rejectIconTemplate) {
                                <i *ngIf="option('rejectIcon')" [class]="option('rejectIcon')" [hBind]="ptm('pcRejectButton')['icon']"></i>
                            }
                    ...
                    >
                        <ng-template #icon>
                            @if (acceptIcon && !_acceptIconTemplate && !acceptIconTemplate) {
                                <i *ngIf="option('acceptIcon')" [class]="option('acceptIcon')" [hBind]="ptm('pcAcceptButton')['icon']"></i>
                            }
