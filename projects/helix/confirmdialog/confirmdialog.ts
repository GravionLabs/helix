        ...
        <h-dialog
          ...
          <ng-template #content>
            @if (iconTemplate || _iconTemplate) {
              ...
              @if (option('icon')) {
                <i [ngClass]="cx('icon')" [class]="option('icon')" [hBind]="ptm('icon')"></i>
              }
            }
                ...
                <ng-template #icon>
                  @if (rejectIcon && !rejectIconTemplate && !_rejectIconTemplate) {
                    @if (option('rejectIcon')) {
                      <i [class]="option('rejectIcon')" [hBind]="ptm('pcRejectButton')['icon']"></i>
                    }
                  }
                ...
                <ng-template #icon>
                  @if (acceptIcon && !_acceptIconTemplate && !acceptIconTemplate) {
                    @if (option('acceptIcon')) {
                      <i [class]="option('acceptIcon')" [hBind]="ptm('pcAcceptButton')['icon']"></i>
                    }
                  }
