...
import { booleanAttribute, ChangeDetectionStrategy, Component, computed, ElementRef, forwardRef, inject, InjectionToken, Input, model, NgModule, numberAttribute, Optional, QueryList, signal, SimpleChanges, TemplateRef, ViewEncapsulation, input, output, contentChild, viewChild, contentChildren } from '@angular/core';
...
export class Tree extends BaseComponent<TreePassThrough> implements BlockableUI {
     ...
     * @group Templates
     */
    readonly filterTemplate = contentChild<TemplateRef<TreeFilterTemplateContext> | undefined>('filter', { descendants: false });
    /**
     ...
     * @group Templates
     */
    readonly loaderTemplate = contentChild<TemplateRef<TreeLoaderTemplateContext> | undefined>('loader', { descendants: false });
    /**
     ...
     * @group Templates
     */
    readonly togglerIconTemplate = contentChild<TemplateRef<TreeTogglerIconTemplateContext> | undefined>('togglericon', { descendants: false });
    /**
     ...
     * @group Templates
     */
    readonly checkboxIconTemplate = contentChild<TemplateRef<TreeCheckboxIconTemplateContext> | undefined>('checkboxicon', { descendants: false });
    /**
