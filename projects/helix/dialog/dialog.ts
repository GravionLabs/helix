                ...
                @if (renderDialog()) {
                    ...
                    >
                        ...
                        <ng-template #notHeadless>
                            <div *ngIf="resizable" [class]="cx('resizeHandle')" [hBind]="ptm('resizeHandle')" [style.z-index]="90" (mousedown)="initResize($event)"></div>
                            <div #titlebar [class]="cx('header')" [hBind]="ptm('header')" (mousedown)="initDrag($event)" *ngIf="showHeader">
                                <span [id]="ariaLabelledBy" [class]="cx('title')" [hBind]="ptm('title')" *ngIf="!_headerTemplate && !headerTemplate && !headerT">{{ header }}</span>
                            ...
                            <div #footer [class]="cx('footer')" [hBind]="ptm('footer')" *ngIf="_footerTemplate || footerTemplate || footerT">
