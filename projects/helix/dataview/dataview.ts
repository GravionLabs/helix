...
@Component({
    ...
    template: `
        @if (loading) {
            <div [hBind]="ptm('loading')" [class]="cx('loading')">
                <div [hBind]="ptm('loadingOverlay')" [class]="cx('loadingOverlay')">
                    @if (loadingIcon) {
                        <i [class]="cn(cx('loadingIcon'), 'pi-spin' + loadingIcon)"></i>
                    } @else {
                        <ng-container>
                            <svg [hBind]="ptm('loadingIcon')" data-p-icon="spinner" [spin]="true" [class]="cx('loadingIcon')" />
        ...
        <div [hBind]="ptm('content')" [class]="cx('content')">
            ...
            @if (isEmpty() && !loading) {
                <div [hBind]="ptm('emptyMessage')" [class]="cx('emptyMessage')">
