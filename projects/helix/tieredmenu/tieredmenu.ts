...
import { TieredMenuItemTemplateContext, TieredMenuPassThrough } from '@gravionlabs/helix/types/tieredmenu';
    ...
    template: `
        @if (render()) {
          <ul
            ...
            [hBind]="_ptm(root ? 'rootList' : 'submenu')"
            (keydown)="menuKeydown.emit($event)"
            (focus)="menuFocus.emit($event)"
            (blur)="menuBlur.emit($event)"
            [style]="inlineStyles"
            [hMotion]="root ? true : visible"
                      ...
                      @if (!getItemProp(processedItem, 'routerLink')) {
                        <a
                          ...
                          @if (getItemProp(processedItem, 'escape')) {
                            ...
                            <ng-template [ngTemplateOutlet]="htmlLabel"></ng-template>
                          }
