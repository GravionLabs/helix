...
import { GvNotfound, GvNotfoundSuggestion } from './notfound';

describe('GvNotfound', () => {
  let component: GvNotfound;
  let fixture: ComponentFixture<GvNotfound>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GvNotfound);
  ...
  it('should reflect custom suggestions input', () => {
    const suggestions: GvNotfoundSuggestion[] = [
