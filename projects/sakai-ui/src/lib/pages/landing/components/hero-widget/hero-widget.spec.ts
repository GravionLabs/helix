...
import { GvHeroWidget } from './hero-widget';

describe('GvHeroWidget', () => {
  let component: GvHeroWidget;
  let fixture: ComponentFixture<GvHeroWidget>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [GvHeroWidget],
    }).compileComponents();

    fixture = TestBed.createComponent(GvHeroWidget);
