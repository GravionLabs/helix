...
import { GvPricingWidget } from './pricing-widget';

describe('GvPricingWidget', () => {
  let component: GvPricingWidget;
  let fixture: ComponentFixture<GvPricingWidget>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [GvPricingWidget],
    }).compileComponents();

    fixture = TestBed.createComponent(GvPricingWidget);
  ...
  it('planSelect output should emit selected plan', () => {
    const emitted: GvPricingPlan[] = [];
    component.planSelect.subscribe((p: GvPricingPlan) => emitted.push(p));
