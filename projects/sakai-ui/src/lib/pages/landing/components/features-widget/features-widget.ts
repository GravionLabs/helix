...
const DEFAULT_FEATURES: GvFeature[] = [
  {
...
const DEFAULT_TESTIMONIAL: GvTestimonial = {
...
export class GvFeaturesWidget {
  sectionTitle = input('Marvelous Features');
  sectionSubtitle = input('Placerat in egestas erat...');
  features = input<GvFeature[]>(DEFAULT_FEATURES);
  testimonial = input<GvTestimonial | null>(DEFAULT_TESTIMONIAL);
}
