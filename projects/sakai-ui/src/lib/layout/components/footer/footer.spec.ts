...
import { GvFooter } from './footer';
import { GvFooterColumn } from './footer.model';

describe('GvFooter', () => {
  let component: GvFooter;
  let fixture: ComponentFixture<GvFooter>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GvFooter);
  ...
  it('should reflect custom columns input', () => {
    const columns: GvFooterColumn[] = [{ title: 'Company', links: [{ label: 'About' }] }];
