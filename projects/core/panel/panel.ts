...
import { BlockableUI, Footer, HelixTemplate, SharedModule } from '@helix-ui/core/api';
...
import type { PanelAfterToggleEvent, PanelBeforeToggleEvent, PanelHeaderIconsTemplateContext, PanelPassThrough } from '@helix-ui/core/types/panel';
