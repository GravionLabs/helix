...
import type { SliderChangeEvent, SliderSlideEndEvent } from '@gravionlabs/helix-core/types/slider';
import { SliderPassThrough } from '@gravionlabs/helix-core/types/slider';
...
export class Slider extends BaseEditableHolder<SliderPassThrough> {
     ...
     * @group Props
     */
    readonly animate = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
     ...
     * @group Props
     */
    readonly range = input<boolean, unknown>(undefined, { transform: booleanAttribute });
    /**
