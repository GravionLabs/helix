...
describe('buildValidator', () => {
  it('should return null when the gate passes', () => {
    const validator = buildValidator(() => true, ValidatorKey.Required, 'This is required');
    expect(validator(new FormControl('hello'))).toBeNull();
  });

  it('should return error with static string message when gate fails', () => {
    const validator = buildValidator(() => false, ValidatorKey.Required, 'This is required');
  ...
  it('should return error with function message when gate fails', () => {
    const msg: ValidatorMessage = (value) => `Value "${value}" is invalid`;
    const validator = buildValidator(() => false, ValidatorKey.Pattern, msg);
...
describe('Validators', () => {
  describe('required', () => {
    ...
    it('should return error with function message', () => {
      const msg: ValidatorMessage = (v) => `"${v}" is required`;
      const v = Validators.required(msg);
  ...
  describe('email', () => {
    it('should pass a valid email', () => {
      const v = Validators.email('Invalid email');
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.email('Invalid email', false);
      expect(v(new FormControl(''))).toEqual({ Email: 'Invalid email' });
    });

    it('should support function message', () => {
      const v = Validators.email((val) => `"${val}" is not valid`);
  ...
  describe('pattern', () => {
    it('should pass a matching value', () => {
      const v = Validators.pattern('Invalid', /^[a-z]+$/);
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.pattern('Invalid', /^[a-z]+$/, false);
      expect(v(new FormControl(''))).toEqual({ Pattern: 'Invalid' });
    });

    it('should support function message', () => {
      const v = Validators.pattern((val) => `"${val}" does not match`, /^\d+$/);
  ...
  describe('date', () => {
    it('should pass an ISO date string', () => {
      const v = Validators.date('Invalid date');
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.date('Invalid date', false);
      expect(v(new FormControl(''))).toEqual({ Date: 'Invalid date' });
    });

    it('should support function message', () => {
      const v = Validators.date((val) => `"${val}" is not a date`);
  ...
  describe('number', () => {
    it('should pass a numeric value', () => {
      const v = Validators.number('Invalid number');
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.number('Invalid number', false);
      expect(v(new FormControl(''))).toEqual({ Number: 'Invalid number' });
    });

    it('should support function message', () => {
      const v = Validators.number((val) => `"${val}" is not a number`);
  ...
  describe('integer', () => {
    it('should pass a whole number', () => {
      const v = Validators.integer('Invalid integer');
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.integer('Invalid integer', false);
      expect(v(new FormControl(''))).toEqual({ Integer: 'Invalid integer' });
    });

    it('should support function message', () => {
      const v = Validators.integer((val) => `"${val}" is not integer`);
  ...
  describe('min', () => {
    it('should pass a value equal to minimum', () => {
      const v = Validators.min('Too small', 5);
      expect(v(new FormControl(5))).toBeNull();
    });
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.min('Too small', 5, false);
      expect(v(new FormControl(''))).toEqual({ Min: 'Too small' });
    });

    it('should support function message', () => {
      const v = Validators.min((val) => `Min is 5, got ${val}`, 5);
  ...
  describe('max', () => {
    it('should pass a value equal to maximum', () => {
      const v = Validators.max('Too large', 10);
      expect(v(new FormControl(10))).toBeNull();
    });
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.max('Too large', 10, false);
      expect(v(new FormControl(''))).toEqual({ Max: 'Too large' });
    });

    it('should support function message', () => {
      const v = Validators.max((val) => `Max is 10, got ${val}`, 10);
  ...
  describe('minLength', () => {
    it('should pass a string at minimum length', () => {
      const v = Validators.minLength('Too short', 3);
      expect(v(new FormControl('abc'))).toBeNull();
    });
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.minLength('Too short', 3, false);
      expect(v(new FormControl(''))).toEqual({ MinLength: 'Too short' });
    });

    it('should support function message', () => {
      const v = Validators.minLength((val: string) => `Length ${val.length} < 3`, 3);
  ...
  describe('maxLength', () => {
    it('should pass a string at maximum length', () => {
      const v = Validators.maxLength('Too long', 5);
      expect(v(new FormControl('hello'))).toBeNull();
    });
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.maxLength('Too long', 5, false);
      expect(v(new FormControl(''))).toEqual({ MaxLength: 'Too long' });
    });

    it('should support function message', () => {
      const v = Validators.maxLength((val: string) => `Length ${val.length} > 5`, 5);
  ...
  describe('oneOf', () => {
    it('should pass a value in options', () => {
      const v = Validators.oneOf('Not allowed', ['a', 'b', null]);
    ...
    it('should fail a value not in options', () => {
      const v = Validators.oneOf('Not allowed', ['a', 'b']);
    ...
    it('should support function message', () => {
      const v = Validators.oneOf((val) => `"${val}" is not allowed`, ['a']);
  ...
  describe('allOf', () => {
    it('should pass when all elements are in options', () => {
      const v = Validators.allOf('Not allowed', [1, 2, 3]);
      expect(v(new FormControl([1, 2]))).toBeNull();
    });
    ...
    it('should fail empty value when allowEmpty=false', () => {
      const v = Validators.allOf('Not allowed', [1, 2, 3], false);
      expect(v(new FormControl(''))).toEqual({ AllOf: 'Not allowed' });
    });

    it('should support function message', () => {
      const v = Validators.allOf((val) => `${JSON.stringify(val)} has invalid items`, [1, 2]);
