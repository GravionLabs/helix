...
import { ChevronUpIcon } from '@helix-ui/core/icons';
import { MotionDirective } from '@helix-ui/core/motion';
import { ScrollTopIconTemplateContext, ScrollTopPassThrough } from '@helix-ui/core/types/scrolltop';
