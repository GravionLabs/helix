...
import { ChevronUpIcon } from '@helix/core/icons';
import { MotionDirective } from '@helix/core/motion';
import { ScrollTopIconTemplateContext, ScrollTopPassThrough } from '@helix/core/types/scrolltop';
