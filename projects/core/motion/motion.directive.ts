...
import { createMotion, resolveDuration, type ClassNameOptions, type MotionEvent, type MotionInstance, type MotionOptions, type MotionPhase } from '@gravionlabs/helix-core/uix/motion';
...
export class MotionDirective extends BaseComponent {
     ...
     * @group Props
     */
    visible = input<boolean>(false, { alias: 'hMotion' });
    /**
