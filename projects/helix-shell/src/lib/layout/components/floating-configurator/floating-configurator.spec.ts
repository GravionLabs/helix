...
import { HelixFloatingConfigurator } from './floating-configurator';

describe('HelixFloatingConfigurator', () => {
  let component: HelixFloatingConfigurator;
  let fixture: ComponentFixture<HelixFloatingConfigurator>;
  let store: InstanceType<typeof LayoutStore>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HelixFloatingConfigurator],
    ...
    fixture = TestBed.createComponent(HelixFloatingConfigurator);
