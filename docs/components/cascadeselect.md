...
| `activeOptionPath` | `any[]` | `undefined!` | — |
| `optionDisabled` | `any[]` | `undefined!` | — |
| `focusedOptionId` | `string \| undefined` | — | — |
| `options` | `string \| any[] \| string[] \| null \| undefined` | — | — |
| `optionGroupChildren` | `string \| string[] \| null \| undefined` | — | — |
...
| `optionGroupChildren` | `string \| string[] \| null \| undefined` | — | Property name or getter function to retrieve the items of a group. |
| `placeholder` | `string \| undefined` | — | Default text to display when no option is selected. |
| `value` | `string \| null \| undefined` | — | Selected value of the component. |
...
| Name | Type | Description |
| --- | --- | --- |
| `onChange` | `output&lt;CascadeSelectChangeEvent&gt;()` | Callback to invoke on value change. |
| `onGroupChange` | `output&lt;Event&gt;()` | Callback to invoke when a group changes. |
| `onShow` | `output&lt;CascadeSelectShowEvent&gt;()` | Callback to invoke when the overlay is shown. |
| `onHide` | `output&lt;CascadeSelectHideEvent&gt;()` | Callback to invoke when the overlay is hidden. |
| `onClear` | `output&lt;any&gt;()` | Callback to invoke when the clear token is clicked. |
| `onBeforeShow` | `output&lt;CascadeSelectBeforeShowEvent&gt;()` | Callback to invoke before overlay is shown. |
| `onBeforeHide` | `output&lt;CascadeSelectBeforeHideEvent&gt;()` | Callback to invoke before overlay is hidden. |
| `onFocus` | `output&lt;FocusEvent&gt;()` | Callback to invoke when input receives focus. |
| `onBlur` | `output&lt;FocusEvent&gt;()` | Callback to invoke when input loses focus. |
