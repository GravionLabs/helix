...
| `severity` | `"secondary" \| "info" \| "success" \| "warn" \| "danger" \| "contrast" \| "help" \| "primary" \| null \| undefined` | — | Defines the style of the button. |
...
| `size` | `"large" \| "small" \| null \| undefined` | `null` | Defines the size of the button. |
...
| --- | --- | --- |
| `onClick` | `output&lt;MouseEvent&gt;()` | Callback to invoke when default command button is clicked. |
| `onMenuHide` | `output&lt;any&gt;()` | Callback to invoke when overlay menu is hidden. |
| `onMenuShow` | `output&lt;any&gt;()` | Callback to invoke when overlay menu is shown. |
| `onDropdownClick` | `output&lt;MouseEvent \| undefined&gt;()` | Callback to invoke when dropdown button is clicked. |
