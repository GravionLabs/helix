...
| `unselectable` | `boolean` | `false` | Whether selection can be cleared. |
...
| --- | --- | --- |
| `onOptionClick` | `output&lt;SelectButtonOptionClickEvent&gt;()` | Callback to invoke on input click. |
| `onChange` | `output&lt;SelectButtonChangeEvent&gt;()` | Callback to invoke on selection change. |
