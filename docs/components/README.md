...
| Module | Description |
| --- | --- |
| [Accordion](accordion.md) | Accordion groups a collection of contents in tabs. |
| [AutoComplete](autocomplete.md) | AutoComplete is an input component that provides real-time suggestions when being typed. |
| [Avatar](avatar.md) | Avatar represents people using icons, labels and images. |
| [AvatarGroup](avatargroup.md) | AvatarGroup is a helper component for Avatar. |
| [Badge](badge.md) | Badge is a small status indicator for another element. |
| [BlockUI](blockui.md) | BlockUI can either block other components or the whole page. |
| [Breadcrumb](breadcrumb.md) | Breadcrumb provides contextual information about page hierarchy. |
| [Button](button.md) | Button is an extension to standard button element with icons and theming. |
...
| [Divider](divider.md) | Divider is used to separate contents. |
| [Dock](dock.md) | Dock is a navigation component consisting of menuitems. |
| [Drawer](drawer.md) | Sidebar is a panel component displayed as an overlay at the edges of the screen. |
...
| [InputGroupAddon](inputgroupaddon.md) | InputGroupAddon displays text, icon, buttons and other content can be grouped next to an input. |
| [InputIcon](inputicon.md) | InputIcon displays an icon. |
...
| [Menu](menu.md) | Menu is a navigation / command component that supports dynamic and static positioning. |
| [Menubar](menubar.md) | Menubar is a horizontal menu component. |
| [Message](message.md) | Message groups a collection of contents in tabs. |
| [MeterGroup](metergroup.md) | MeterGroup displays scalar measurements within a known range. |
| [MultiSelect](multiselect.md) | MultiSelect is used to select multiple items from a collection. |
| [OrderList](orderlist.md) | OrderList is used to manage the order of a collection. |
| [OrganizationChart](organizationchart.md) | OrganizationChart visualizes hierarchical organization data. |
| [OverlayBadge](overlaybadge.md) | OverlayPanel is a container component positioned as connected to its target. |
| [Paginator](paginator.md) | Paginator is a generic component to display content in paged format. |
| [Panel](panel.md) | Panel is a container with the optional content toggle feature. |
| [PanelMenu](panelmenu.md) | PanelMenu is a hybrid of Accordion and Tree components. |
| [Password](password.md) | Password displays strength indicator for password fields. |
| [PickList](picklist.md) | PickList is used to reorder items between different lists. |
| [Popover](popover.md) | Popover is a container component that can overlay other components on page. |
| [ProgressBar](progressbar.md) | ProgressBar is a process status indicator. |
| [ProgressSpinner](progressspinner.md) | ProgressSpinner is a process status indicator. |
| [RadioButton](radiobutton.md) | RadioButton is an extension to standard radio button element with theming. |
| [Rating](rating.md) | Rating is an extension to standard radio button element with theming. |
| [Scroller](scroller.md) | Scroller is a performance-approach to handle huge data efficiently. |
| [ScrollPanel](scrollpanel.md) | ScrollPanel is a cross browser, lightweight and themable alternative to native browser scrollbar. |
| [ScrollTop](scrolltop.md) | ScrollTop gets displayed after a certain scroll position and used to navigates to the top of the page quickly. |
| [Select](select.md) | Select is used to choose an item from a collection of options. |
| [SelectButton](selectbutton.md) | SelectButton is used to choose single or multiple items from a list using buttons. |
| [Skeleton](skeleton.md) | Skeleton is a placeholder to display instead of the actual content. |
| [Slider](slider.md) | Slider is a component to provide input with a drag handle. |
| [SpeedDial](speeddial.md) | When pressed, a floating action button can display multiple primary actions that can be performed on a page. |
| [SplitButton](splitbutton.md) | SplitButton groups a set of commands in an overlay with a default command. |
| [Splitter](splitter.md) | Splitter is utilized to separate and resize panels. |
| [Stepper](stepper.md) | Stepper is a component that streamlines a wizard-like workflow, organizing content into coherent steps and visually guiding users through a numbered progression in a multistep process. |
| [Steps](steps.md) | Steps components is an indicator for the steps in a wizard workflow. |
| [Table](table.md) | Table displays data in tabular format. |
...
| [ToggleButton](togglebutton.md) | ToggleButton is used to select a boolean value using a button. |
| [ToggleSwitch](toggleswitch.md) | ToggleSwitch is used to select a boolean value. |
| [Toolbar](toolbar.md) | Toolbar is a grouping component for buttons and other content. |
| [Tree](tree.md) | Tree is used to display hierarchical data. |
...
| Module | Description |
| --- | --- |
| [API](api.md) | Shared services, tokens, and template primitives used across all Helix components. |
| [Base](base.md) | Base style layer and theming glue shared by every Helix component. |
| [BaseComponent](basecomponent.md) | Abstract base class providing pass-through, styling, and config plumbing for all Helix components. |
