...
| `modalEnterAnimation` | `string \| null \| undefined` | `'h-modal-enter'` | Enter animation class name of modal. |
| `modalLeaveAnimation` | `string \| null \| undefined` | `'h-modal-leave'` | Leave animation class name of modal. |
...
| --- | --- | --- |
| `onShow` | `output&lt;any&gt;()` | Triggered when the preview overlay is shown. |
| `onHide` | `output&lt;any&gt;()` | Triggered when the preview overlay is hidden. |
