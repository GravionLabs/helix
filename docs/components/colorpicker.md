...
| --- | --- | --- |
| `onChange` | `output&lt;ColorPickerChangeEvent&gt;()` | Callback to invoke on value change. |
| `onShow` | `output&lt;any&gt;()` | Callback to invoke on panel is shown. |
| `onHide` | `output&lt;any&gt;()` | Callback to invoke on panel is hidden. |
