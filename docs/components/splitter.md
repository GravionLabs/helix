...
| `stateKey` | `string \| null \| undefined` | `null` | Storage identifier of a stateful Splitter. |
...
| --- | --- | --- |
| `onResizeEnd` | `output&lt;SplitterResizeEndEvent&gt;()` | Callback to invoke when resize ends. |
| `onResizeStart` | `output&lt;SplitterResizeStartEvent&gt;()` | Callback to invoke when resize starts. |
